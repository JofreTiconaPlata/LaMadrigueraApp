...
class _RegistrarIngresoPageState extends ConsumerState<RegistrarIngresoPage> {
  ...
  Future<void> registrarIngreso() async {
    ...
    try {
      ...
      Navigator.pushNamed(context, RouteNames.vehiculosEstacionados);
    } catch (error) {
      if (!mounted) return;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text(
            'Registra ingresos de vehículos o revisa los vehículos actualmente estacionados.',
          ),
          ...
          OutlinedButton.icon(
            ...
            label: const Text('Ver vehículos estacionados'),
          ),
          ...
          vehiculosAsync.when(
            ...
            error: (error, _) => _ErrorView(
              message:
                  'No se pudieron cargar los vehículos para registrar ingreso.',
              error: error,
